...
\begin{itemize}
    ...
    \item \textbf{Khả năng thích nghi:} Nhanh chóng nắm bắt các công cụ hỗ trợ hiện đại như Cursor AI kết hợp với quy trình làm việc chuẩn Agile/Scrum.
\end{itemize}
\subsection{Hạn chế và Những thách thức cần vượt qua}
\begin{itemize}
    \item Các thuật toán xử lý ảnh lặp (dHash) hoặc đo nhịp tim (PPG) đôi khi vẫn gặp sai số trong môi trường ánh sáng cực yếu.
    \item Khả năng diễn giải các cấu trúc thuật toán phức tạp thông qua sơ đồ (Diagram) vẫn cần được rèn luyện thêm.
\end{itemize}

\section{KẾT QUẢ TỔNG THỂ VÀ ĐỊNH HƯỚNG}
\subsection{Kết quả đạt được}
\begin{itemize}
    \item \textbf{Hoàn thành các mốc tiến độ:} Đã trực tiếp tham gia phát triển 5 ứng dụng di động đa lĩnh vực. Trong đó, có 3 sản phẩm đã chính thức phát hành thành công trên App Store (Blood Sugar, Blood Pressure, Cleaner Guru) và các dự án mới đang được khởi tạo bộ khung.
...
\begin{itemize}
    \item \textbf{Ngắn hạn:} Tập trung phối hợp xây dựng toàn bộ tính năng chuyển đổi PDF, tạo tài liệu DOCX offline và ký tay số cục bộ cho app PDF Converter, đồng thời tích hợp Ads cho Cleaner Guru.
    \item \textbf{Dài hạn:} Phấn đấu trở thành một Chuyên gia phát triển ứng dụng di động (Senior Mobile Developer) tại \textbf{FAA Việt Nam}.
\end{itemize}
