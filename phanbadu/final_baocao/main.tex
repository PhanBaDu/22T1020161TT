...
Trong thời đại kỷ nguyên số và sự phát triển mạnh mẽ của công nghệ thông tin, điện thoại di động thông minh đã trở thành một công cụ cá nhân đắc lực và không thể thiếu. Đi cùng với đó, nhu cầu của người dùng về các giải pháp theo dõi sức khỏe chủ động (iVita Health ecosystem), ứng dụng thể thao thông minh tích hợp trí tuệ nhân tạo (Push Up AI), tối ưu hóa bộ nhớ thiết bị (Cleaner Guru) và số hóa văn phòng (PDF Converter \& Scanner) ngày càng tăng cao, đòi hỏi các ứng dụng di động phải có tính ổn định vượt trội, bảo mật thông tin và trải nghiệm người dùng tối ưu.

Nhận thức rõ những cơ hội và thách thức của ngành phát triển phần mềm di động, em đã đăng ký tham gia kỳ thực tập tốt nghiệp kéo dài hơn một năm (bắt đầu từ tháng 06/2025) tại \textbf{Công ty FAA Việt Nam} - một doanh nghiệp công nghệ năng động hàng đầu chuyên nghiên cứu và phát hành các sản phẩm di động thương mại ra thị trường toàn cầu. Dưới sự kèm cặp trực tiếp của Mentor Phan Bá Đủ, em đã được trực tiếp gõ code, tối ưu hóa phần cứng và hoàn thiện quy trình phát hành thành công ứng dụng \textbf{Ad-Free Blood Pressure App} lên App Store toàn cầu.

Báo cáo thực tập tốt nghiệp này tổng kết lại toàn bộ chặng đường học tập, làm việc thực tế và những đóng góp chuyên môn của em tại doanh nghiệp, bao gồm các phần chính:
\begin{itemize}
    \item \textbf{1. Thông tin chung và Mục tiêu thực tập:} Đặc tả thông tin cá nhân, đơn vị tiếp nhận thực tập cùng các kỳ vọng kỹ năng chuyên môn cần trau dồi.
    \item \textbf{2. Tổng quan công việc được giao:} Giới thiệu các dự án đã tham gia phát triển và sơ đồ UML Use Case phân hệ nghiệp vụ.
    \item \textbf{3. Báo cáo tiến độ theo Timeline:} Chi tiết hóa 5 giai đoạn thực tập hơn 1 năm qua, từ làm quen quy trình Agile/Scrum đến lập trình PPG đo nhịp tim, dHash tối ưu hóa RAM và lõi nén PDF/DOCX đa luồng.
    \item \textbf{4. Tự đánh giá và bài học kinh nghiệm:} Đánh giá trung thực các thế mạnh đạt được, hạn chế còn tồn tại và các bài học kinh nghiệm đúc kết.
    \item \textbf{5. Kết luận và kiến nghị:} Tổng kết chặng đường thực tập tốt nghiệp hơn 1 năm qua và đề xuất định hướng nghiên cứu trí tuệ nhân tạo trên di động.
    \item \textbf{6. Hình ảnh minh họa giao diện ứng dụng:} Trình bày chi tiết giao diện thực tế của 5 dự án ứng dụng di động đã phát triển.
    \item \textbf{7. Tài liệu tham khảo:} Cung cấp danh sách các tài liệu hướng dẫn kỹ thuật và liên kết ứng dụng chính thức trên App Store.
\end{itemize}

Dù bản thân đã nỗ lực hết mình để hoàn thiện báo cáo một cách khoa học và chỉn chu nhất, song do giới hạn về mặt thời gian cũng như kinh nghiệm thực tiễn của một sinh viên, báo cáo chắc chắn khó tránh khỏi những thiếu sót. Em kính mong nhận được các ý kiến góp ý chân thành và sự chỉ bảo dạy dỗ của quý thầy cô để báo cáo được hoàn thiện tốt hơn.
...
\subsection{Kết luận}
Trải qua quá trình thực tập tốt nghiệp và làm việc lâu dài hơn một năm tại \textbf{Công ty FAA Việt Nam}, dưới sự kèm cặp sát sao của Mentor Phan Bá Đủ, em đã tích lũy được khối lượng lớn kinh nghiệm thực tiễn và hoàn thành xuất sắc các mục tiêu đề ra:
\begin{itemize}
    \item \textbf{Về mặt kỹ thuật:} Làm chủ và vận dụng linh hoạt framework Flutter cùng ngôn ngữ Dart. Nghiên cứu sâu sắc các bài toán hiệu năng bao gồm: kỹ thuật đo nhịp tim PPG qua camera, thị giác máy tính nhận diện tư thế Google MediaPipe, tối ưu hóa RAM khi quét ảnh dHash thông qua Method Channel và xử lý nén đa luồng (Isolate).
    \item \textbf{Về mặt sản phẩm:} Trực tiếp tham gia phát triển 5 dự án di động thực tế cho doanh nghiệp, trong đó tự tay thiết kế, tối ưu hóa và xuất bản thành công ứng dụng \textbf{Ad-Free Blood Pressure App} lên App Store toàn cầu, đạt được mốc tăng trưởng hơn 100 người dùng hoạt động tự nhiên trong tuần đầu phát hành.
    \item \textbf{Về mặt quy trình:} Trưởng thành trong kỹ năng cộng tác nhóm Agile/Scrum, kiểm soát code chất lượng cao qua quy trình Git Flow và Code Review chéo, cũng như nâng cao năng lực viết tài liệu kỹ thuật.
\end{itemize}

\subsection{Kiến nghị và Hướng phát triển}
Để các sản phẩm ứng dụng di động tiếp tục nâng cao tính thương mại và thu hút người dùng trên thị trường toàn cầu, em xin đề xuất một số định hướng phát triển:
\begin{itemize}
    \item \textbf{Nghiên cứu On-device AI chuyên sâu:} Tích hợp các mô hình trí tuệ nhân tạo cục bộ (offline) để nhận diện thói quen sức khỏe người dùng và tối ưu hóa phân tích hình ảnh mà không cần gửi dữ liệu lên server, đảm bảo tính bảo mật tuyệt đối của thông tin y tế.
    \item \textbf{Tối ưu hóa phễu chuyển đổi doanh thu:} Cải thiện mô hình kinh doanh bằng cách kết hợp linh hoạt giữa quảng cáo AdMob SDK và đăng ký thành viên (Subscription) để tối đa hóa doanh thu cho doanh nghiệp.
\end{itemize}
...
\newpage
\subsection{Dự án Ad-Free Blood Pressure App}
...
\begin{enumerate}
    \item \textbf{Ứng dụng Ad-Free Blood Pressure App trên cửa hàng App Store:} \url{https://apps.apple.com/us/app/ad-free-blood-pressure-app/id6749716071}
    ...
    \item \textbf{Tích hợp quảng cáo SDK Google AdMob cho Flutter:} \url{https://pub.dev/packages/google_mobile_ads}
